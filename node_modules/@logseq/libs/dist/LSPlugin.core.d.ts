...
import { ILSPluginThemeManager, SettingSchemaDesc, ThemeOptions } from './LSPlugin';
declare global {
    interface Window {
...
declare class PluginSettings extends EventEmitter<'change' | 'reset'> {
    ...
    private _schema?;
    private _settings;
    constructor(_userPluginSettings: any, _schema?: Array<SettingSchemaDesc>);
    get<T = any>(k: string): T;
    set(k: string | Record<string, any>, v?: any): void;
    set settings(value: Record<string, any>);
    get settings(): Record<string, any>;
    setSchema(schema: Array<SettingSchemaDesc>, syncSettings?: boolean): void;
    reset(): void;
...
declare class PluginLocal extends EventEmitter<'loaded' | 'unloaded' | 'beforeunload' | 'error'> {
    ...
    get settingsSchema(): Array<SettingSchemaDesc>;
