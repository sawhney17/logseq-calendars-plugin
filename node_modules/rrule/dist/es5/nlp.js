...
var totext_ToText = /** @class */ (function () {
    ...
    ToText.prototype.isFullyConvertible = function () {
        return isFullyConvertible(this.rrule);
    };
    /**
 ...
 * @return {Boolean}
 */
function isFullyConvertible(rrule) {
    var canConvert = true;
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "isFullyConvertibleToText", function() { return isFullyConvertible; });
 ...
 */
function fromText(text, language) {
    if (language === void 0) { language = i18n; }
